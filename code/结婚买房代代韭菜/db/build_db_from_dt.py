...
import sys
sys.path.append("..")
from app.config import TXT_PATH, PDF_IDX_PATH
from app.utils import bs_generator
from db.db_config import TABLE_NAME
from db.db_schema import schema, schema_zh2py, schema_meta, schema_base, schema_fin, schema_emp
import pandas as pd
import sqlite3
from tqdm import tqdm
from db.db_utils import *
from app.doc_tree import DocTree
...
for col in schema_base:
    fillna_dict[col] = ""
for col in schema_fin:
    fillna_dict[col] = 0
for col in schema_emp:
    fillna_dict[col] = 0
fillna_dict["小数位数"] = '2'
